...
Private Sub Form_Load() ''Botsareus 8/7/2012 mod for new version
    Me.Caption = "DarwinBots V2.45.03 DNA Help"
    lblTitle.Caption = "DarwinBots V2.45.03 DNA Help"
    help.text = ""
    help.text = help.text + vbTab + vbTab + vbTab + vbTab + "DarwinBots V2.45.03 DNA" + vbCrLf
    help.text = help.text + "" + vbCrLf
